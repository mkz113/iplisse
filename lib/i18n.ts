...
export const translations = {
    RO: {
        ...
        displayCurrency: "Monedă de afișare",
        cardStripe: "Card Bancar (Stripe)",
        neoPaySoon: "NeoPay (În curând)",
        neoPayAlert: "Metoda NeoPay va fi disponibilă curând!",
        deleteError: "Eroare la ștergerea produsului.",
        sessionExpired: "Sesiune expirată. Te rugăm să te reautentifici.",
        saveOrderError: "Eroare la salvarea comenzii.",
        unexpectedCheckoutError: "A apărut o eroare neașteptată în timpul finalizării.",
        orderWord: "Comandă",
        itemWordSingular: "produs",
        itemWordPlural: "produse",
    ...
    RU: {
        ...
        cardStripe: "Банковская карта (Stripe)",
        neoPaySoon: "NeoPay (Скоро)",
        neoPayAlert: "Метод NeoPay скоро будет доступен!",
        deleteError: "Ошибка при удалении товара.",
        sessionExpired: "Сессия истекла. Пожалуйста, войдите снова.",
        saveOrderError: "Ошибка при сохранении заказа.",
        unexpectedCheckoutError: "Произошла непредвиденная ошибка при оформлении.",
        orderWord: "Заказ",
        itemWordSingular: "товар",
        itemWordPlural: "товара(-ов)",
